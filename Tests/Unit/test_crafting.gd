...
class TestCrafting:
	...
	func after_all():
		gut.p("ran cleanup", 2)
	func test_combine():
		crafting.chosen_recipe = [crafting.Items.ITEM1, crafting.Items.ITEM2, crafting.Items.ITEM3]
		assert_eq(crafting.Items.ITEM6, crafting.combine())
	func test_craft_success():
		#var arr = [crafting.Items.ITEM1, crafting.Items.ITEM2, crafting.Items.ITEM3]
		var a  = crafting.craft(crafting.Items.ITEM6)
		assert_eq(a, crafting.Items.ITEM6)
	func test_craft_failed():
		var a  = crafting.craft(crafting.Items.ITEM7)

...
var drag_data = null
signal _set_item
#add Items by loading them into their  .tres files here.
export (Array, Resource) var items_res = [
	load("res://Game/Assets/Items/BluePotion.tres"), null,  null,  null,  load("res://Game/Assets/Items/GreenPotion.tres"),  null,  null,  null,  null    
]
